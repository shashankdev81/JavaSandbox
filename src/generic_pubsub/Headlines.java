...
public class Headlines implements IMessage{
    ...
    public Headlines withMessage(String publisherId, String message, String topic) {
    ...
    public Headlines withTimeAndTTL(Date creationTime, long ttl) {
    ...
    public boolean equals(Object o) {
        ...
        Headlines message1 = (Headlines) o;
