...
public class SynchronisedCache<K, V> implements Cache<K, V> {
    ...
    public SynchronisedCache(int size, CacheType type) {
        this.size = size;
    ...
    * */
    ...
    public static void main(String[] args) {
        SynchronisedCache<Integer, String> cache = new SynchronisedCache<Integer, String>(5, CacheType.LRU);
